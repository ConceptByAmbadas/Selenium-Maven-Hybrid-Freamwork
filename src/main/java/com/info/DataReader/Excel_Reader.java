...
public class Excel_Reader {
	...
	public static void main(String[] args) {
		 ...
		 * "E:\\GITWorkspace\\com.info.HybridFreamwork\\src\\main\\java\\com\\info\\TestDataFile\\Datasheet.xlsx";
		 * String sheetName = "Enquiry_Form"; Excel_Reader excel = new
		 * Excel_Reader(); excel.getExcelData(excellocation, sheetName);
		 */
	}
}